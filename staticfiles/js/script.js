(function($) {
	...
	if ($('.event-block-inner').length) {
		...
		eventImgItems.forEach((item) => {
			...
			if (hoverElement) { // Only add event listeners if hoverElement exists
	...
	if ($('#email-form').length) {
		$(document).on('click', '#submit', function(event) {
			...
			if (firstname === "") {
				$('#email-form .response').append('<div class="failed">First name is required.</div>');
			}
			if (lastname === "") {
				$('#email-form .response').append('<div class="failed">Last name is required.</div>');
			}
			if (email === "") {
				$('#email-form .response').append('<div class="failed">Email is required.</div>');
			} else if (!isValidEmail(email)) {
				$('#email-form .response').append('<div class="failed">Please enter a valid email address.</div>');
			}
			if (phone === "") {
				$('#email-form .response').append('<div class="failed">Phone number is required.</div>');
			}
			if (message === "") {
				$('#email-form .response').append('<div class="failed">Message is required.</div>');
			}
